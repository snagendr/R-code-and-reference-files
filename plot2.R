...
with(df2,plot(hpctime,g_a_power,xlab=" ",ylab="Global Active Power (Kilowatts)",type="n"))
lines(df2$hpctime,df2$g_a_power)
...
print("Job over")
print("Please review the plot2.png file created in your working directory")
